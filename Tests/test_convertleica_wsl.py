...
lif_file_path = '/mnt/e/data/100T-21-P-NegOverlapTilescan.lif'  # Replace with your LIF file path
outputfolder = '/mnt/e/data/.processed'
altoutputfolder='/mnt/u/cc'
...
# lif_file_path='/mnt/c/data/XLEF/Test-3-4-Channels.xlef'
# outputfolder = '/mnt/c/data/XLEF/.processed'
# altoutputfolder='/mnt/c/data/XLEF/omeropath'
